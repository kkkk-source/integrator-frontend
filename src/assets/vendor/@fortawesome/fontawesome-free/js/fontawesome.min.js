...
!(function () {
        ...
        return (function (t, e) {
          ...
          try {
            for (
              ...
              !(a = (o = s.next()).done) && (r.push(o.value), !e || r.length !== e);
              a = !0
            );
          } catch (t) {
            (n = !0), (i = t);
  ...
  var I = H[u],
    ...
    _ = !1;
  c &&
    ((_ = (d.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(d.readyState)) ||
      d.addEventListener('DOMContentLoaded', function t() {
        d.removeEventListener('DOMContentLoaded', t),
          (_ = 1),
          F.map(function (t) {
            return t();
          });
    ...
    return {
      ...
      inner: {
        transform:
          ...
          ') ' +
          ' ' +
          ('scale(' + (e.size / 16) * (e.flipX ? -1 : 1) + ', ' + (e.size / 16) * (e.flipY ? -1 : 1) + ') ') +
          ' ' +
          ('rotate(' + e.rotate + ' 0 0)'),
      },
      path: { transform: 'translate(' + (a / 2) * -1 + ' -256)' },
    };
  }
  var $ = { x: 0, y: 0, width: '100%', height: '100%' },
    tt = function (t) {
      var e = t.children,
        ...
        m = {
          ...
          children: [{ tag: 'path', attributes: E({}, s.attributes, c.path, { fill: 'black' }) }],
        },
        ...
        p = {
          tag: 'defs',
          children: [
            { tag: 'clipPath', attributes: { id: h }, children: [f] },
            {
              tag: 'mask',
              attributes: E({}, $, { id: g, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
              children: [u, d],
            },
          ],
        };
      return (
        e.push(p, {
          tag: 'rect',
          attributes: E({ fill: 'currentColor', 'clip-path': 'url(#' + h + ')', mask: 'url(#' + g + ')' }, $),
        }),
    ...
    et = function (t) {
      ...
      if ((0 < i.length && (r.style = i), Q(n))) {
        var o = Z({ transform: n, containerWidth: a.width, iconWidth: a.width });
        e.push({
          tag: 'g',
          ...
          children: [
            {
              ...
              children: [{ tag: a.icon.tag, children: a.icon.children, attributes: E({}, a.icon.attributes, o.path) }],
            },
          ],
        });
      } else e.push(a.icon);
    ...
    rt = function (t) {
      ...
      if (Q(o) && r.found && !a.found) {
        var s = r.width / r.height / 2,
          l = 0.5;
        n.style = J(E({}, i, { 'transform-origin': s + o.x / 16 + 'em ' + (l + o.y / 16) + 'em' }));
      }
      ...
      return [
        {
          ...
          children: [{ tag: 'symbol', attributes: E({}, n, { id: o }), children: a }],
        },
      ];
    };
  function nt(t) {
    var e = t.icons,
      ...
      p = [T.replacementClass, i ? T.familyPrefix + '-' + i : '', h]
        .filter(function (t) {
    ...
    u && (v.attributes[A] = ''),
      l &&
        v.children.push({
          tag: 'title',
          attributes: { id: v.attributes['aria-labelledby'] || 'title-' + q() },
          children: [l],
        });
    var b = E({}, v, { prefix: n, iconName: i, main: r, mask: a, transform: o, symbol: s, styles: f.styles }),
  ...
  function it(t) {
    ...
    Q(n) &&
      ((y.transform =
        ((u = (c = { transform: n, startCentered: !0, width: r, height: a }).transform),
        (m = c.width),
        (d = void 0 === m ? C : m),
        (g = c.height),
        (h = void 0 === g ? C : g),
        ...
        (b +=
          (v = void 0 !== p && p) && k
            ? 'translate(' + (u.x / B - d / 2) + 'em, ' + (u.y / B - h / 2) + 'em) '
            : v
            ? 'translate(calc(-50% + ' + u.x / B + 'em), calc(-50% + ' + u.y / B + 'em)) '
            : 'translate(' + u.x / B + 'em, ' + u.y / B + 'em) '),
        (b += 'scale(' + (u.size / B) * (u.flipX ? -1 : 1) + ', ' + (u.size / B) * (u.flipY ? -1 : 1) + ') '),
      ...
      pt = ut(
        ...
        function (t, e) {
          var r = e[0],
            a = e[1],
            n = e[2];
          return 'far' !== a || i || (a = 'fas'), (t[r] = { prefix: a, iconName: n }), t;
        },
        {}
      );
    };
  ...
  function xt(t) {
    return t.reduce(function (t, e) {
      ...
      if (yt[e]) t.prefix = e;
        ...
        var a = 'fa' === t.prefix ? pt[r] || { prefix: null, iconName: null } : {};
  ...
  var zt = {
    replace: function (t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML =
          r + (T.keepOriginalSource && 'svg' !== e.tagName.toLowerCase() ? '\x3c!-- ' + e.outerHTML + ' --\x3e' : '');
    ...
    nest: function (t) {
      ...
      var n = r[0].attributes.class.split(' ').reduce(
        function (t, e) {
  ...
  function Et(t) {
    if (s && T.observeMutations) {
      ...
      (Lt = new s(function (t) {
          ...
          U(t).forEach(function (t) {
            if (
              ('childList' === t.type &&
                ...
                !Nt(t.addedNodes[0]) &&
                (T.searchPseudoElements && o(t.target), n(t.target)),
              'attributes' === t.type && t.target.parentNode && T.searchPseudoElements && o(t.target.parentNode),
              'attributes' === t.type && Nt(t.target) && ~z.indexOf(t.attributeName))
            )
        ...
        c && Lt.observe(r, { childList: !0, attributes: !0, characterData: !0, subtree: !0 });
    }
  }
  var Ot = function (t) {
  ...
  var jt = function (t) {
      var e,
        ...
        o = xt(V(t));
      return (
        a && n && ((o.prefix = a), (o.iconName = n)),
        o.prefix && 1 < i.length
          ? (o.iconName = ((e = o.prefix), (r = t.innerText), ht[e][r]))
          : o.prefix && 1 === i.length && (o.iconName = bt(o.prefix, Pt(t.innerText))),
        o
      );
    },
    Rt = function (t) {
    ...
    It = function (t) {
      ...
      return (
        T.autoA11y && (r ? (e['aria-labelledby'] = T.replacementClass + '-title-' + q()) : (e['aria-hidden'] = 'true')),
        e
      );
    },
    Ft = function (t) {
  ...
  var Bt = { fill: 'currentColor' },
    ...
    qt = {
      ...
      children: [
        ...
        {
          tag: 'circle',
          attributes: E({}, Bt, { cx: '256', cy: '364', r: '28' }),
          children: [
            { tag: 'animate', attributes: E({}, Dt, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
            { tag: 'animate', attributes: E({}, Xt, { values: '1;0;1;1;0;1;' }) },
          ],
        },
        {
          tag: 'path',
          ...
          children: [{ tag: 'animate', attributes: E({}, Xt, { values: '1;0;0;0;0;1;' }) }],
        },
        {
          tag: 'path',
          attributes: E({}, Bt, {
          ...
          children: [{ tag: 'animate', attributes: E({}, Xt, { values: '0;0;1;1;0;0;' }) }],
        },
      ],
    },
    Ut = I.styles,
  ...
  function Qt(t, e) {
    var r = { found: !1, width: 512, height: 512, icon: qt };
    if (t && e && Ut[e] && Ut[e][t]) {
      var a = Ut[e][t];
      r = {
        found: !0,
  ...
  function Zt(t) {
    ...
    return ~w.extra.classes.indexOf(Vt)
      ? (function (t, e) {
          var r = e.title,
            a = e.transform,
            n = e.extra,
          ...
          return (
            T.autoA11y && !r && (n.attributes['aria-hidden'] = 'true'),
            [t, it({ content: t.innerHTML, width: i, height: o, transform: a, title: r, extra: n, watchable: !0 })]
          );
        })(t, w)
      : ((u = t),
        (d = (m = w).iconName),
        ...
        [
          u,
          nt({
            icons: { main: Qt(d, h), mask: Qt(b.iconName, b.prefix) },
            prefix: h,
            iconName: d,
            transform: p,
            symbol: v,
              ...
              [':before', ':after'].forEach(function (e) {
                ...
                if (t && !a) u.removeChild(t);
                  ...
                  if (!t || t.getAttribute(p) !== o || t.getAttribute(v) !== s) {
                    ...
                    ':before' === e ? u.insertBefore(c, u.firstChild) : u.appendChild(c),
                      (c.outerHTML = f
                        .map(function (t) {
                          return Ct(t);
                        })
  ...
  var se,
    ...
    ce = {
      ...
      watch: function () {
        ...
        !1 === T.autoReplaceSvg && (T.autoReplaceSvg = !0),
          (T.observeMutations = !0),
          Y(function () {
            de({ autoReplaceSvgRoot: e }),
              Et({ treeCallback: te, nodeCallback: ee, pseudoElementsCallback: $t, observeMutationsRoot: r });
          });
      },
    },
    ue =
      ((se = function (t) {
        ...
        if (t) {
          var p = t.prefix,
            v = t.iconName,
            b = t.icon;
          return ie(E({ type: 'icon' }, t), function () {
            return (
              ne(),
              T.autoA11y &&
                (f ? (d['aria-labelledby'] = T.replacementClass + '-title-' + q()) : (d['aria-hidden'] = 'true')),
              nt({
                icons: { main: ae(b), mask: s ? ae(s.icon) : { found: !1, width: null, height: null, icon: {} } },
                prefix: p,
                iconName: v,
                transform: E({}, D, a),
                symbol: i,
      ...
      function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          r = (t || {}).icon ? t : oe(t || {}),
          a = e.mask;
        return a && (a = (a || {}).icon ? a : oe(a || {})), se(r, E({}, e, { mask: a }));
      }),
    me = {
      noAuto: function () {
      ...
      text: function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          c = e.styles,
          u = void 0 === c ? {} : c;
        return ie({ type: 'text', content: t }, function () {
          return (
            ne(),
            it({
              content: t,
              transform: E({}, D, a),
              title: i,
              extra: { attributes: f, styles: u, classes: [T.familyPrefix + '-layers-text'].concat(P(s)) },
            })
          );
        });
      },
      counter: function (t) {
        var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
          ...
          l = e.styles,
          f = void 0 === l ? {} : l;
        return ie({ type: 'counter', content: t }, function () {
          return (
            ne(),
            (function (t) {
              var e = t.content,
              ...
              var o = [];
              return (
                o.push({ tag: 'span', attributes: n, children: [e] }),
                r && o.push({ tag: 'span', attributes: { class: 'sr-only' }, children: [r] }),
                o
              );
            })({
              content: t.toString(),
              title: a,
              extra: { attributes: s, styles: f, classes: [T.familyPrefix + '-layers-counter'].concat(P(i)) },
            })
          );
        });
      },
      layer: function (t) {
        return ie({ type: 'layer' }, function () {
          ne();
          var e = [];
          return (
            t(function (t) {
            ...
            [{ tag: 'span', attributes: { class: T.familyPrefix + '-layers' }, children: e }]
          );
        });
      },
      toHtml: Ct,
    ...
    de = function () {
      var t = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot,
        e = void 0 === t ? d : t;
      0 < Object.keys(I.styles).length && c && T.autoReplaceSvg && me.dom.i2svg({ node: e });
    };
  !(function (t) {
    try {
      t();
    ...
    f &&
      (m.FontAwesome || (m.FontAwesome = me),
      Y(function () {
        de(), Et({ treeCallback: te, nodeCallback: ee, pseudoElementsCallback: $t });
      })),
      (I.hooks = E({}, I.hooks, {
